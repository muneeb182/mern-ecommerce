...
const ProductUpdate = () => {
  ...
  const handleDelete = async() =>{
    try {
      let answer = window.confirm("Are You really want to delete a product?");
      if(!answer) return;
          ...
          {image && (
            <div className="text-center">
              <img
                src={image}
                alt="product"
                className="block mx-auto mb-6 w-[600px] h-[40%]"
              />
            </div>
          )}

          <div className="mb-3">
            <label className="text-black  px-4 block w-full text-center border rounded-lg cursor-pointer font-bold py-11">
